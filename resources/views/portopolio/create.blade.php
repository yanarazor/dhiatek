...
<div class="page-content-inner">
    <div class="row">
        <div class="col-md-12"> 
            ...
            <form action="{{ route('portopolio.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Tambah Portopolio</span>
                                </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_project" placeholder="Nama" value="{{ old('nama_project') }}"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Tag</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="tag" placeholder="tag" value="{{ old('tag') }}"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Foto</label>
                                            <div class="input-group">
