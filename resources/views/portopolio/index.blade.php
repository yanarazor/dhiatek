        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Portpolio </span>
                </div>
                <div class="actions">
            ...
            <form action="#" id="form-search" method="post" accept-charset="utf-8">
                ...
                <table class="filter_pegawai" sborder=0 width='100%' cellpadding="10">
                    <tr>
                        <td width="200px"><label for="example-text-input" class="col-form-label">Nama Project</label></td>
                        <td colspan=2><input class="form-control" type="text" name="nama" value="" ></td>
                    </tr>
                    <tr>
                        <td width="200px"><label for="example-text-input" class="col-form-label">Tag</label></td>
                        <td colspan=2><input class="form-control" type="text" name="tag" value="" ></td>
                    </tr>
                    <tr>
                        <td colspan=4>
                            <a href="{{ route('portopolio.create') }}" class="btn blue button-submit pull-right show-modal"> Tambah
...
<script src="{{ asset('/metronic/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js') }}" type="text/javascript"></script>
 <script type="text/javascript">
      ...
      $table = $(".table-data").DataTable({
        ...
        ajax: {
            "url": "{{ route('portopolio','action=datatable') }}",
            "data": function(d) {
        ...
        "aoColumns": [
            {
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, full) {
                            if (full.image_preview) {
                                return "<img src='{{ asset('/assets/img/portfolio') }}/" + full.image_preview + "' height='40px' />";
                            }else
                                return "";
                        }
                    },
                    {
                        ...
                        "mRender": function(data, type, full) {
                            ...
                            if (full.edit_url) {
                                actions.push("<a data-toggle='tooltip' title='Edit data' href='" + full.edit_url + "' class='btn btn-sm btn-warning'  ><i class='fa fa-edit'></i></a>");
                            }
                            if (full.delete_url) {
