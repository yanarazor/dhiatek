                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Create Client</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                    <div class="box-body">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                              <input id='nama' type='text' class="form-control"  name='nama' maxlength='30' value="{{ old('nama') }}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNama" class="col-sm-2 control-label">Logo Client</label>
                                            <div class="col-md-12">
