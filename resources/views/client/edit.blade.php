        ...
        <div class="col-md-12">
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('clientupdate',$record->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" placeholder="Nama" value="{{ $record->nama }}"> </div>
                            </div>
                            <div class="form-group">
                                <label>Logo</label>
                                <div class="input-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="input-group input-large">
                                            ...
                                            <span class="input-group-addon btn-file btn-success">
                                                ...
                                                <input type="file" name="logo_client"> 
                                            </span>
                                    ...
                                    <br>
                                    @if($record->logo)
                                    <img src="{{ url('/assets/img/clients/'.$record->logo) }}" height="100px"/>
                                    @endif
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('client') }}" class="btn default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
