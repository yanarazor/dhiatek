        ...
        <div class="portlet light ">
            ...
            <form action="#" id="form-search" method="post" accept-charset="utf-8">
                ...
                <table class="filter_pegawai" sborder=0 width='100%' cellpadding="10">
                    <tr>
                        <td width="200px"><label for="example-text-input" class="col-form-label">Nama Team</label></td>
                        <td colspan=2><input class="form-control" type="text" name="nama" value="" ></td>
                    </tr>
                    <tr>
                        <td colspan=4>
                            <a href="{{ route('team.create') }}" class="btn blue button-submit pull-right show-modal"> Tambah
...
<script src="{{ asset('/metronic/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js') }}" type="text/javascript"></script>
 <script type="text/javascript">
      ...
      $table = $(".table-data").DataTable({
        ...
        ajax: {
            "url": "{{ route('team','action=datatable') }}",
            "data": function(d) {
        ...
        "aoColumns": [
            {
                    ...
                    
                    {
                        ...
                        "mRender": function(data, type, full) {
                            if (full.foto) {
                                return "<img src='{{ asset('/assets/img/team') }}/" + full.foto + "' height='40px' />";
                            }else
                                return "";
                        }
                    },
